...
- Example: 'Research AI agent–powered payment systems (covering technology stack, regulatory compliance, and market adoption) with primary focus on personalization and autonomous transaction management as specified by the user.'
...
Please ensure that your response is in the same language as the user’s question (i.e., if the question is in English, answer in English; if in Korean, answer in Korean).
</Language Requirement>
